...
PositionController::PositionController() : rclcpp::Node("position_controller") {
    ...
    odomsub_ = this->create_subscription<nav_msgs::msg::Odometry>(odometry_topic, 10, std::bind(&PositionController::loop, this, _1));
    goalsub_ = this->create_subscription<geometry_msgs::msg::PoseStamped>(goal_topic, 10, std::bind(&PositionController::get_goal, this, _1));
